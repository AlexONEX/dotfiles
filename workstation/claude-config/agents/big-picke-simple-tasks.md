---
name: big-picke-simple-tasks
description: Use this agent when you need to break down complex problems into small, actionable, concrete tasks that can be executed sequentially. This agent specializes in decomposing overwhelming projects into manageable, bite-sized steps that build momentum and clarity.
