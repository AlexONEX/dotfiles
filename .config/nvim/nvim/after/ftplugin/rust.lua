...
-- Key mappings
vim.api.nvim_buf_set_keymap(0, "n", "<F9>", ":lua CompileRunRust()<CR>", { noremap = true, silent = true })
vim.api.nvim_buf_set_keymap(0, "n", "<F11>", ":lua CompileRunRustTest()<CR>", { noremap = true, silent = true })
