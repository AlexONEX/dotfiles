...
function compile_run_rust_test()
	local src_dir = vim.fn.expand("%:p:h")
...
-- Key mappings
vim.api.nvim_buf_set_keymap(0, "n", "<F9>", ":lua compile_run_rust()<CR>", { noremap = true, silent = true })
vim.api.nvim_buf_set_keymap(0, "n", "<F11>", ":lua compile_run_rust()<CR>", { noremap = true, silent = true })
...
-- Example: Use rustfmt for formatting
vim.g.rustfmt_autosave = 1

-- Optional: Add Rust-specific commands
vim.cmd([[command! RustTest lua compile_run_rust_test()]])
