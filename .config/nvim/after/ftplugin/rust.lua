...
-- Key mappings using vim.keymap.set instead of vim.api.nvim_buf_set_keymap
vim.keymap.set("n", "<F9>", ":lua RustUtils.compile_run_rust()<CR>", { noremap = true, silent = true, buffer = 0 })
vim.keymap.set("n", "<F11>", ":lua RustUtils.compile_run_rust()<CR>", { noremap = true, silent = true, buffer = 0 })
vim.keymap.set("n", "<C-s>", ":lua vim.lsp.buf.format()<CR>", { noremap = true, silent = true, buffer = 0 })
