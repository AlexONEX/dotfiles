...
vim.keymap.set(
	"n",
	"<F9>",
	":lua Ftplugin_Haskell.compile_run_haskell()<CR>",
	{ noremap = true, silent = true, buffer = 0 }
)
vim.keymap.set("n", "<F10>", ":lua Ftplugin_Haskell.run_haskell()<CR>", { noremap = true, silent = true, buffer = 0 })
vim.keymap.set(
	"n",
	"<F11>",
	":lua Ftplugin_Haskell.compile_run_haskell()<CR>",
...
vim.keymap.set(
	"n",
	"<C-s>",
	":lua Ftplugin_Haskell.format_haskell()<CR>",
	{ noremap = true, silent = true, buffer = 0 }
)
vim.keymap.set(
	"n",
	"<leader>hl",
	":lua Ftplugin_Haskell.run_hlint()<CR>",
	{ noremap = true, silent = true, buffer = 0 }
)
